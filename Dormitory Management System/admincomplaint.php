    ...
    <section class="maincontent">
        <div class="panel">
            <ul>
                ...
                <li class="liPeople"><a href="adminannounce.php"><i class="fa fa-fw fa-envelope"></i>Announcement</a></li>
                
            </ul>
        </div>
        <div class="content">
            <input type="button" name="changecomplaint" onclick="openpopup()" class="addcomplaint" value="Update Complaint">
            <br>
            <br>
            <br>
           <table id="tablerooms">
           ...
           <div class="popup" id="popup">
                ...
                <form method="POST" action="updatecomplaint.php">
                    ...
                    <br>
                    <br>
                    <input type="submit" value="Update Complaint" class="addbtns">
                    <br>
